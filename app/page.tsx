...
import { angleAt, distance, polygonArea, polygonPerimeter, resizeWallKeepingAdjacent, snapPoint } from '../lib/geometry';
...
export default function Home() {
  ...
  function setWallLength(index: number, lengthMm: number) {
    ...
    setPoints(current => resizeWallKeepingAdjacent(current, index, Math.round(lengthMm / 10) * 10));
  }
